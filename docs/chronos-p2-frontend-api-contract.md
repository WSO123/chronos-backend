...
```json
{
  "ai_job": {
    ...
    "prompt_version": "p2-task-semantic-planning-agent-v2",
    "job_metadata": {}
  },
  "planning_signal": {
    "id": "uuid",
    ...
    "task_type": "writing",
    "complexity": "high",
    "complexity_reason": "需要完成方案判断和结构化输出。",
    "cognitive_load": "high",
    "energy_fit": "high_energy",
    "blocking_risk": "high",
    "estimated_duration_min": 60,
    "duration_confidence": 0.56,
    "duration_reason": "完整任务偏大，但可以先做一个较小切片。",
    "goal_alignment_score": 0.9,
    "goal_progress_impact": "large",
    "goal_relevance_reason": "该任务直接推进当前高价值目标。",
